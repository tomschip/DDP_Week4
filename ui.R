    ...
    mainPanel(
       tabsetPanel(type = "tabs",
                   ...
                   tabPanel("Documentation",br(),
                        h4("This prediction is based off of the reviews of 80 breakfast cereals and can be found here:
                                https://www.kaggle.com/crawford/80-cereals/downloads/80-cereals.zip/2"),
                        h4("The four most influential factors of the data set were used in this prediction model")),
                   tabPanel("Github Location", br(),
                        h4("https://github.com/tomschip/DDP_Week4"))
       )
    )                    
